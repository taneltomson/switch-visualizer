$(function(){ // on dom ready
    ...
    function restoreSavedLayoutOnReadyEvent(event) {
        event.cy.json(JSON.parse(localStorage.getItem('graphLayout')));
